...
struct File {
	...
	//read file from external partion to my partion
	bool read(string s) {
	...
	//Write file to external partion
...
struct Folder {
	...
	//show the content of my partion
	...
	//recurion to obtain the name file and folder in the folder and read to my partion
	...
	//copy folder external partion to my partion
